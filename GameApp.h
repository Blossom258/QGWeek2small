...
public:
	...
	enum class ShowMode { WoodCrate, FireAnim ,Mixture};
...
private:
	...
	// 星之卡比纹理
	ComPtr<ID3D11ShaderResourceView> m_pOne;				
	ComPtr<ID3D11ShaderResourceView> m_pTwo;
	ComPtr<ID3D11ShaderResourceView> m_pThree;
	ComPtr<ID3D11ShaderResourceView> m_pFour;
	ComPtr<ID3D11ShaderResourceView> m_pFive;
	ComPtr<ID3D11ShaderResourceView> m_pSix;

	ComPtr<ID3D11ShaderResourceView> m_pMixture;				//混合纹理
